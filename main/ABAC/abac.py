...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.lbUsername.setGeometry(QtCore.QRect(30, 30, 200, 17))
    ...
    def retranslateUi(self, MainWindow):
        ...
        # self.cbResource.setItemText(0, _translate("MainWindow", "students"))
        # self.cbResource.setItemText(1, _translate("MainWindow", "customers"))
        # self.cbResource.setItemText(2, _translate("MainWindow", "staffs"))
        # self.cbResource.setItemText(3, _translate("MainWindow", "customers"))
        # self.cbResource.setItemText(4, _translate("MainWindow", "partners"))
