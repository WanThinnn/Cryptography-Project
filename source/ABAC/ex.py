...
# Nhập các thuộc tính từ bàn phím trên một dòng
input_data = input("Enter input values separated by spaces (e.g., admin finance manager financial_report view): ")

# Tách các giá trị nhập vào
subject_role, subject_department, subject_position, resource_type, action_method = input_data.split()
